...
try {
    ...
    Assert-Equal $metadata.requested_version "v5.5.0" "Onboarding metadata requested version yazmali."
    Assert-Equal $metadata.installed_version "v5.5.0" "Onboarding metadata installed version yazmali."
