# Marketing Agent — Agent ve Skill Listesi (v5.5.2)
...
- v5.5.1 → v5.5.2: Drive kurulum tamiri, Turkce karakter sozlesmesi, orchestrator yonlendirmesi,
  release-only dosya ayiklama ve Projects root ilk promptu netlestirildi.
