...
Assert-Text (Join-Path $AgentRoot "agents\onboarding-guide.md") "7. Sizi daha iyi" "Onboarding yedinci serbest profil sorusu eksik"
Assert-Text (Join-Path $AgentRoot "agents\onboarding-guide.md") "ben otisti" "Onboarding ek kullanici baglami ornegi eksik"
Assert-Text (Join-Path $AgentRoot "agents\onboarding-guide.md") "shared personal context accurately" "Onboarding serbest ek bilgileri profile kaydetme kurali eksik"
...
Assert-Text (Join-Path $AgentRoot "templates\workspace-bootstrap-AGENTS.md") ".pa/project/marketer-profile.md" "Project bootstrap marketer profilini okumaya yonlendirmeli"
...
if (Test-Path -LiteralPath $createProjectPath) {
    ...
    Assert-Text $createProjectPath "onboarding-install.json" "create-project.ps1 Projects root kurulum metadata fallback'ini kullanmiyor"
