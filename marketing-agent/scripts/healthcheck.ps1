...
Test-RequiredText "pipelines\idea-to-prd.md" "fikir-degerlendirme"
...
Test-RequiredText "AGENTS.md" "Projects root"
Test-RequiredText "AGENTS.md" "Yeni proje workspace'i"
Test-RequiredText "AGENTS.md" "fikir degerlendirme proje icinde"
