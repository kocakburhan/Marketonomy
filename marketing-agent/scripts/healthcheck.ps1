...
Test-RequiredText "pipelines\idea-to-prd.md" "Optional for later execution guidance"
Test-RequiredText "pipelines\idea-to-prd.md" "Project workspace only"
...
Test-RequiredText "skills\list.md" "v5.4.2"
...
Test-RequiredText "..\mvp\mvp.md" "Codex App + Google Drive for desktop + onayli PowerShell create/install/update scriptleri"
